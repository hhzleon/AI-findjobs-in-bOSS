...
find_job_url = "https://www.zhipin.com/wapi/zpgeek/search/joblist.json?page=1&pageSize=1&city=101210100&query=%E5%85%A8%E6%A0%88%E5%BC%80%E5%8F%91&expectInfo=&multiSubway=&multiBusinessDistrict=&position=&jobType=&salary=&experience=&degree=&industry=&scale=&stage=&scene=1&_=1754484555555"
...
def build_job_list_url(page=1, pageSize=30):
    job_list_url = f"https://www.zhipin.com/wapi/zpgeek/search/joblist.json?page={page}&pageSize={pageSize}&city=101210100&query=%E5%85%A8%E6%A0%88%E5%BC%80%E5%8F%91&expectInfo=&multiSubway=&multiBusinessDistrict=&position=&jobType=&salary=&experience=&degree=&industry=&scale=&stage=&scene=1&_=1754484555555"
    return job_list_url

def build_job_getdata_url(securityId):
    get_job_data = f"https://www.zhipin.com/wapi/zpgeek/job/detail.json?securityId={securityId}&lid=1xvobQL6J7G.search.1&_=1754484522292"
    return get_job_data
